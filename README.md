...
Implementing NavigationLink for screen transitions

Passing data between views

Structuring SwiftUI applications using multiple views
...
Receives the selected book title

Displays the selected item

Contains a button to navigate to the Info Screen
...
Includes a Go Back button to return to the previous screen
